...
namespace PlotBox\Standards\PlotBox\Sniffs\Arrays;
    ...
    public function processMultiLineArray($phpcsFile, $stackPtr, $arrayStart, $arrayEnd)
    {
        ...
        */
        ...
        if ($keyUsed === false && empty($indices) === false) {
            ...
            if ($tokens[$trailingContent]['code'] !== T_COMMA) {
                ...
                $error = 'Comma disallowed after last value in array declaration';
        ...
        */
        ...
        foreach ($indices as $index) {
            ...
            $isLastLine = ($indices[count($indices) - 1] === $index);
            if ($isLastLine && $nextComma !== false && ($tokens[$nextComma]['line'] === $valueLine)) {
                $error = 'Final line in an array declaration must not end in a comma';
